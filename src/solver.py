...
from compute_loss_update_params import ComputeLossAccUpdateParams
import pathlib
...
class Solver(object):
    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            if self.save_best:
                ...
                torch.save(
                    ...
                    str(basedir) + "/models/" + self.model_type.lower() + '_loss_' + str(round(loss,3)) + ".pth",
                )
        ...
        print(f'Train Time: {train_time_end-train_time_start_overall} Seconds')
    ...
    def MainLoop(self, epoch, data_loader):
        ...
        for idx, (data, target) in enumerate(data_loader):
            ...
            out, loss, batch_acc = ComputeLossAccUpdateParams(data, target, self.model, self.criterion, self.optimizer)
